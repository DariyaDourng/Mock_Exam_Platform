...
export default function StudentSidebarPage({ sidebarOpen, setSidebarOpen }: StudentSidebarProps) {
      ...
      <div className={`flex items-center gap-3 px-4 py-6 border-b border-slate-800 flex-shrink-0 ${isCollapsed && !isMobile ? 'justify-center px-2' : ''}`}>
        ...
        {(!isCollapsed || isMobile) && (
          <div className="min-w-0 flex-1">
            ...
            <p className="text-[10px] uppercase tracking-widest text-slate-500 font-semibold truncate">Student Portal</p>
          </div>
        )}
        {!isMobile && (
          <button
